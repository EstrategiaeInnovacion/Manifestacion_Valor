        ...
        try {
            ...
            foreach ($covesData as $coveIdx => $cove) {
               ...
               <mv:pedimento>
                ...
                // =====================================================
                // VALIDACIÓN: al menos uno de los tres tipos de pago es obligatorio.
                // NO se generan datos ficticios para no comprometer la veracidad
                // fiscal del documento ante el SAT.
                // =====================================================
                if (empty($covePrecioPagado) && empty($covePrecioPorPagar) && empty($coveCompensoPago)) {
                    $errors[] = "COVE {$numeroCove}: debe registrar al menos un tipo de pago (Precio Pagado, Precio por Pagar o Compenso de Pago) antes de transmitir.";
                    Log::warning('[MV_SOAP] COVE sin ningún tipo de pago registrado', [
                        'cove' => $numeroCove,
                        'cove_idx' => $coveIdx
                    ]);
                }
