<x-app-layout>
    <x-slot name="title">Nueva Pregunta Frecuente</x-slot>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="hidden md:block text-sm font-bold text-[#001a4d] uppercase tracking-wider">Nueva Pregunta Frecuente</span>
                    </div>
        ...
        <main class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-[#001a4d] tracking-tight">Nueva Pregunta</h1>
                        <p class="text-slate-500 text-sm mt-1">Agrega una nueva pregunta frecuente al sistema.</p>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('faqs.store') }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <textarea id="question" name="question" required rows="2" maxlength="500"
                        ...
                        class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm text-[#001a4d] font-medium focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all outline-none placeholder:text-slate-300 resize-none @error('question') border-red-400 @enderror">{{ old('question') }}</textarea>
                    @error('question')
                ...
                <div>
                    ...
                    <textarea id="answer" name="answer" required rows="8" maxlength="20000"
                        placeholder="Escribe la respuesta detallada aquí. Puedes usar saltos de línea para organizar el contenido."
                        class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm text-[#001a4d] font-medium focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all outline-none placeholder:text-slate-300 resize-y @error('answer') border-red-400 @enderror">{{ old('answer') }}</textarea>
                    @error('answer')
                        <p class="mt-1.5 text-xs text-red-600 font-semibold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="flex flex-col justify-center">
                        ...
                        <label class="inline-flex items-center gap-3 cursor-pointer select-none">
                            ...
                            <span class="text-sm font-semibold text-[#001a4d]">Publicar inmediatamente</span>
                        </label>
                ...
                <div>
                    ...
                    <label for="faqAttachments"
                        ...
                        <span class="text-sm font-medium text-slate-400 group-hover:text-cyan-600 transition-colors">Haz clic para adjuntar archivos</span>
